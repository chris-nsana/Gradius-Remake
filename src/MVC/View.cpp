...
void View::addTexture(int typeOfEntity){
	...
	case 0:
		{sp->loadFromFile("./../src/images/PlayerSprite.png");
		textures[typeOfEntity] = sp;
		break;}

	case 1:
		{sp->loadFromFile("./../src/images/PlayerBullet.png");
		textures[typeOfEntity] = sp;
		break;}

	case 3:
		{
		if(level == 1) sp->loadFromFile("./../src/images/BackgroundLevel1.png");
		else if(level == 2) sp->loadFromFile("./../src/images/BackgroundLevel2.png");
		else if(level == 3) sp->loadFromFile("./../src/images/BackgroundLevel3.jpg");
		textures[typeOfEntity] = sp;
		break;
		}
	...
	case 4:
		{
		sp->setRepeated(true);
		if(level == 1) sp->loadFromFile("./../src/images/BorderLevel1.jpeg");
		else if(level == 2) sp->loadFromFile("./../src/images/BorderLevel2.png");
		else if(level == 3) sp->loadFromFile("./../src/images/BorderLevel3.png");
		textures[typeOfEntity] = sp;
		break;
		}
